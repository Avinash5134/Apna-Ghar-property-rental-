      ...
      <main className="main">
          ...
          <div className="home__container container grid">
            <div className="home__data">
              <span className="home__data-subtitle">
                Rent Your Dream Home Now
              </span>
              <h1 className="home__data-title">
                Welcome to <br /> APNA GHAR : <br /> Your{" "}
                <b> Rental Sanctuary </b>
              </h1>
              <Link to="/discover" className="button1">
                Explore
              </Link>
            </div>
            ...
            <div className="home__info">
              <div>
                <span className="home__info-title">
                  Discover Top Rental Destinations with Apna Ghar
                </span>
                <Link
                  to="/discover"
          ...
          <div className="about__container container grid">
            <div className="about__data">
              <h2 className="section__title about__title">
                Discover Exquisite Locations for
                <br /> Your Next Home
              </h2>
              <p className="about__description">
                Embark on a journey to find your perfect abode amidst stunning
                landscapes and serene surroundings. With exclusive deals and
                personalized guidance, Apna Ghar ensures you secure the ideal
                rental at unbeatable prices. Your dream property awaits, reserve
                your spot now.
              </p>
        ...
        <section className="experience section">
          <h2 className="section__title">
            ...
            <br /> With Over 20 Years of Expertise
          </h2>
          <div className="experience__container container grid">
            <div className="experience__content grid">
              ...
              <div className="experience__data">
                ...
                <span className="experience__description">
                  Properties <br /> Successfully Rented
                </span>
              </div>
              <div className="experience__data">
                <h2 className="experience__number">650+</h2>
                <span className="experience__description">
                  Offering Rentals in <br /> Desirable Locations
                </span>
              </div>
            </div>
        ...
        <section className="video section">
          ...
          <div className="video__container container">
            <p className="video__description">
              Explore stunning rental properties with our immersive video tours.
              Discover the perfect place for you and your family.
            </p>
        ...
        <section className="place section" id="place">
          ...
          <div className="place__container container grid">
              ...
              <div className="place__content">
                ...
                <div className="place__data">
                  <h3 className="place__title">
                    Luxury Beachfront Villa(200sqm)
                  </h3>
            ...
            <div className="place__card">
              ...
              <div className="place__content">
                ...
                <div className="place__data">
                  ...
                  <span className="place__subtitle">
            ...
            <div className="place__card">
              <img src={l1} alt="" className="place__img" />
              <div className="place__content">
                <span className="place__rating">
                  <i className="ri-star-line place__rating-icon"></i>
                ...
                <div className="place__data">
                  <h3 className="place__title">Modern Apartment (500sqft)</h3>
                  <span className="place__subtitle">
                    {" "}
                    New Delhi ,India
                  </span>
                  <span className="place__price">₹8,800</span>
                </div>
              </div>
              <Link to="/discover">
                <button className="button button--flex place__button">
            ...
            <div className="place__card">
              ...
              <div className="place__content">
                ...
                <div className="place__data">
                  <h3 className="place__title">
                    Family Home in Sector 75(400sqft)
                  </h3>
