        ...
        {property ? (
          <div className="property-details-container">
            ...
            <div className="property-details">
              ...
              <p>
                ₹{property.price * numNights} / {numNights} Month
              </p>
              ...
              <p className="property-description">
                This modern apartment offers a comfortable stay with all the
                amenities you need. Located in {property.place}, it provides
                easy access to nearby attractions and facilities. Book your stay
                today!
              </p>
            </div>
          </div>
